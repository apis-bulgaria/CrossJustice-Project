...
import { ExpertListComponent } from "./features/expert-list/expert-list.component";
import { ExpertComponent } from "./features/expert-list/expert.component";
import { TranspositionTableComponent } from './features/transposition/transp-table.component';
...
const appRoutes: Routes = [
  ...
  { path: 'expert', component: ExpertComponent, canActivate: [AuthGuard], data: { animation: 'Caseeditor' } },
  { path: 'expert/:id', component: ExpertComponent, canActivate: [AuthGuard], data: { animation: 'Caseeditor' } },
  ...
  { path: 'expertlist', component: ExpertListComponent, canActivate: [AuthGuard], data: { animation: 'Caselist' } },
  ...
  { path: 'transposition', component: TranspositionTableComponent, canActivate: [AuthGuard], data: { animation: 'Register' } }
];
