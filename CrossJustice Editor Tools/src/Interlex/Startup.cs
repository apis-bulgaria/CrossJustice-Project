...
namespace CrossJustice
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                config.AddPolicy(Constants.User, builder => builder.RequireClaim(Constants.Privileges, Constants.User, Constants.Admin, Constants.SuperAdmin));
                config.AddPolicy(Constants.Admin, builder => builder.RequireClaim(Constants.Privileges, Constants.Admin, Constants.SuperAdmin));
                config.AddPolicy(Constants.SuperAdmin, builder => builder.RequireClaim(Constants.Privileges, Constants.SuperAdmin));
            });
