...
namespace CrossJustice.Controllers
{
    ...
    public class CaseController : ControllerBase
    {
        ...
        [HttpGet("GetLegislationEntries/{jurisdiction}")]
        [ResponseCache(NoStore = true)]
        public async Task<IActionResult> GetLegislationEntries(string jurisdiction)
        {
            var legi = await this.service.GetLegislationEntries(jurisdiction);
            return this.Ok(legi);
        } 
